  ...
  return (
    <section className="py-8">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-neutral-900 to-neutral-600 dark:from-white dark:to-neutral-300 bg-clip-text text-transparent mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <LuxuryCard className="p-4 text-center h-full" gradient>
                <div className={`inline-flex p-2.5 rounded-xl bg-gradient-to-r ${feature.color} text-white mb-3 shadow-lg`}>
                  {feature.icon}
                </div>
