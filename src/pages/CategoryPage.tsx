  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
        <HeroSection
          title={categoryTitle}
          description={`Découvrez notre sélection de ${categoryTitle.toLowerCase()} de qualité premium. Des produits soigneusement choisis pour sublimer votre beauté naturelle.`}
          icon={TrendingUp}
        />
